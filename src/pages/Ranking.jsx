...
const Ranking = ({ games }) => {
    return (
        <div className="mb-6 place-content-center flex flex-col w-full items-center gap-[16px] pt-[8px] pb-[24px] px-[16px] rounded-[10px] relative bg-main-bg/50 max-w-screen-lg mx-auto  ">
            ...
            <div className="flex items-center gap-[24px] relative self-stretch w-full flex-[0_0_auto] ">
                ...
                <div className="flex flex-col place-content-center w-full items-start gap-[16px] relative self-stretch">
                ...
                <div className="hidden md:flex flex-col w-full items-start gap-[16px] relative self-stretch">
                ...
                <div  className="hidden lg:flex flex-col w-full items-start gap-[16px] relative self-stretch">
                    <div className="pl-0 pr-[209px] py-0 flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                        <div className=" relative w-fit mt-[-1.00px] [font-family:'Barlow-Bold',Helvetica] font-bold text-[#9ca2c4] text-[16px] tracking-[0.15px] leading-[24px] whitespace-nowrap">
                            *game name*
                        </div>
